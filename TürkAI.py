...
if not st.session_state.user:
    ...
    with col2:
        ...
        # Giriş Notu
        st.markdown("<div class='not-alani'>Yaptığınız oturum sayfayı yenilediğinizde veya giriş çıkış yaptığınızda yeniden oturum açmak zorunda kalınılır şuan betada olduğu için, çalışmalar sürdürülüyor.</div>", unsafe_allow_html=True)
